...
public class DeleteSecurityGroupRuleResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteSecurityGroupRuleResponse deleteSecurityGroupRuleResponse = (DeleteSecurityGroupRuleResponse) o;
    return Objects.equals(this.responseContext, deleteSecurityGroupRuleResponse.responseContext) &&
        Objects.equals(this.securityGroup, deleteSecurityGroupRuleResponse.securityGroup);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteSecurityGroupRuleResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeleteSecurityGroupRuleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteSecurityGroupRuleResponse is not found in the empty JSON string", DeleteSecurityGroupRuleResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeleteSecurityGroupRuleResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSecurityGroupRuleResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSecurityGroupRuleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSecurityGroupRuleResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSecurityGroupRuleResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSecurityGroupRuleResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSecurityGroupRuleResponse>() {
           @Override
           public void write(JsonWriter out, DeleteSecurityGroupRuleResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSecurityGroupRuleResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to DeleteSecurityGroupRuleResponse
  */
