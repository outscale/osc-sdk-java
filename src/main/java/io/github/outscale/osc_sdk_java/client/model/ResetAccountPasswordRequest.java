...
public class ResetAccountPasswordRequest {
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!ResetAccountPasswordRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ResetAccountPasswordRequest is not"
                                        + " found in the empty JSON string",
                                ResetAccountPasswordRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ResetAccountPasswordRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ResetAccountPasswordRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ResetAccountPasswordRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ResetAccountPasswordRequest>() {
                        @Override
                        public void write(JsonWriter out, ResetAccountPasswordRequest value)
                                throws IOException {
