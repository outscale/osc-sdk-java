...
/**
 * Information about the source security group of the load balancer, which you can use as part of
 * your inbound rules for your registered VMs.&lt;br /&gt; To only allow traffic from load
 * balancers, add a security group rule that specifies this source security group as the inbound
 * source.
 */
...
public class SourceSecurityGroup {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(
                        this.securityGroupAccountId, sourceSecurityGroup.securityGroupAccountId)
    ...
    public String toString() {
        ...
        sb.append("    securityGroupAccountId: ")
                .append(toIndentedString(securityGroupAccountId))
                .append("\n");
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!SourceSecurityGroup.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SourceSecurityGroup is not found in"
                                        + " the empty JSON string",
                                SourceSecurityGroup.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `SourceSecurityGroup` properties. JSON: %s",
                                entry.getKey(), jsonObj.toString()));
            }
        }
        if ((jsonObj.get("SecurityGroupAccountId") != null
                        && !jsonObj.get("SecurityGroupAccountId").isJsonNull())
                && !jsonObj.get("SecurityGroupAccountId").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `SecurityGroupAccountId` to be a primitive type in"
                                    + " the JSON string but got `%s`",
                            jsonObj.get("SecurityGroupAccountId").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SourceSecurityGroup>() {
                        @Override
                        public void write(JsonWriter out, SourceSecurityGroup value)
                                throws IOException {
