...
public class CreateVpnConnectionRequest {
    ...
    /**
     * By default or if false, the VPN connection uses dynamic routing with Border Gateway Protocol
     * (BGP). If true, routing is controlled using static routes. For more information about how to
     * create and delete static routes, see [CreateVpnConnectionRoute](#createvpnconnectionroute)
     * and [DeleteVpnConnectionRoute](#deletevpnconnectionroute).
     *
