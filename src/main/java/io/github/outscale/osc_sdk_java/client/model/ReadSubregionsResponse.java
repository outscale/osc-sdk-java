...
import io.github.outscale.osc_sdk_java.client.model.Subregion;
...
public class ReadSubregionsResponse {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReadSubregionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReadSubregionsResponse is not found in the empty JSON string", ReadSubregionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReadSubregionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReadSubregionsResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("Subregions") != null && !jsonObj.get("Subregions").isJsonNull()) {
        ...
        if (jsonArraysubregions != null) {
          ...
          if (!jsonObj.get("Subregions").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `Subregions` to be an array in the JSON string but got `%s`", jsonObj.get("Subregions").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReadSubregionsResponse>() {
           @Override
           public void write(JsonWriter out, ReadSubregionsResponse value) throws IOException {
