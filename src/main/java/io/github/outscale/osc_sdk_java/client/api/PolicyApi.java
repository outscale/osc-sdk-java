...
public class PolicyApi {
    ...
    /**
     * Build call for readEntitiesLinkedToPolicy
     *
     * @param readEntitiesLinkedToPolicyRequest (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * </table>
     */
    public okhttp3.Call readEntitiesLinkedToPolicyCall(
        ...
        Object localVarPostBody = readEntitiesLinkedToPolicyRequest;

        // create path and map variables
        String localVarPath = "/ReadEntitiesLinkedToPolicy";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call readEntitiesLinkedToPolicyValidateBeforeCall(
            ReadEntitiesLinkedToPolicyRequest readEntitiesLinkedToPolicyRequest,
            final ApiCallback _callback)
            throws ApiException {
        return readEntitiesLinkedToPolicyCall(readEntitiesLinkedToPolicyRequest, _callback);
    }
     ...
     * </table>
     */
    public ReadEntitiesLinkedToPolicyResponse readEntitiesLinkedToPolicy(
            ReadEntitiesLinkedToPolicyRequest readEntitiesLinkedToPolicyRequest)
            throws ApiException {
        ApiResponse<ReadEntitiesLinkedToPolicyResponse> localVarResp =
                readEntitiesLinkedToPolicyWithHttpInfo(readEntitiesLinkedToPolicyRequest);
        return localVarResp.getData();
    }

    /**
     * @param readEntitiesLinkedToPolicyRequest (optional)
     * @return ApiResponse&lt;ReadEntitiesLinkedToPolicyResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     *     response body
     * @http.response.details
     *     <table summary="Response Details" border="1">
     ...
     * </table>
     */
    public ApiResponse<ReadEntitiesLinkedToPolicyResponse> readEntitiesLinkedToPolicyWithHttpInfo(
            ReadEntitiesLinkedToPolicyRequest readEntitiesLinkedToPolicyRequest)
            throws ApiException {
        okhttp3.Call localVarCall =
                readEntitiesLinkedToPolicyValidateBeforeCall(
                        readEntitiesLinkedToPolicyRequest, null);
        Type localVarReturnType = new TypeToken<ReadEntitiesLinkedToPolicyResponse>() {}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * </table>
     */
    public okhttp3.Call readEntitiesLinkedToPolicyAsync(
            ReadEntitiesLinkedToPolicyRequest readEntitiesLinkedToPolicyRequest,
            final ApiCallback<ReadEntitiesLinkedToPolicyResponse> _callback)
            throws ApiException {

        okhttp3.Call localVarCall =
                readEntitiesLinkedToPolicyValidateBeforeCall(
                        readEntitiesLinkedToPolicyRequest, _callback);
        Type localVarReturnType = new TypeToken<ReadEntitiesLinkedToPolicyResponse>() {}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
