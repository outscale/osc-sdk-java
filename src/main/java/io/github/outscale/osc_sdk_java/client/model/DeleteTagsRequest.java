...
public class DeleteTagsRequest {
    ...
    public DeleteTagsRequest dryRun(Boolean dryRun) {
    ...
    public DeleteTagsRequest tags(List<ResourceTag> tags) {

        this.tags = tags;
        return this;
    }

    public DeleteTagsRequest addTagsItem(ResourceTag tagsItem) {
        this.tags.add(tagsItem);
        return this;
    }

    /**
     * One or more tags to delete (if you set a tag value, only the tags matching exactly this value
     * are deleted).
     *
     * @return tags
     */
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.dryRun, deleteTagsRequest.dryRun)
     ...
     * @throws IOException if the JSON Object is invalid with respect to DeleteTagsRequest
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!DeleteTagsRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in DeleteTagsRequest is not found in the"
                                        + " empty JSON string",
                                DeleteTagsRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `DeleteTagsRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<DeleteTagsRequest>() {
                        @Override
                        public void write(JsonWriter out, DeleteTagsRequest value)
                                throws IOException {
