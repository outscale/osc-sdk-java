...
public class DeleteSecurityGroupRuleRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteSecurityGroupRuleRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeleteSecurityGroupRuleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteSecurityGroupRuleRequest is not found in the empty JSON string", DeleteSecurityGroupRuleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeleteSecurityGroupRuleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteSecurityGroupRuleRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if ((jsonObj.get("SecurityGroupAccountIdToUnlink") != null && !jsonObj.get("SecurityGroupAccountIdToUnlink").isJsonNull()) && !jsonObj.get("SecurityGroupAccountIdToUnlink").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `SecurityGroupAccountIdToUnlink` to be a primitive type in the JSON string but got `%s`", jsonObj.get("SecurityGroupAccountIdToUnlink").toString()));
      }
      ...
      if ((jsonObj.get("SecurityGroupNameToUnlink") != null && !jsonObj.get("SecurityGroupNameToUnlink").isJsonNull()) && !jsonObj.get("SecurityGroupNameToUnlink").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `SecurityGroupNameToUnlink` to be a primitive type in the JSON string but got `%s`", jsonObj.get("SecurityGroupNameToUnlink").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSecurityGroupRuleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSecurityGroupRuleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSecurityGroupRuleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSecurityGroupRuleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSecurityGroupRuleRequest>() {
           @Override
           public void write(JsonWriter out, DeleteSecurityGroupRuleRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSecurityGroupRuleRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to DeleteSecurityGroupRuleRequest
  */
