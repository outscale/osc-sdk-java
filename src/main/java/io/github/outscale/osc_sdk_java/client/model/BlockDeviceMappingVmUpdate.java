...
public class BlockDeviceMappingVmUpdate {
    ...
    public void setBsu(BsuToUpdateVm bsu) {
        this.bsu = bsu;
    }

    public BlockDeviceMappingVmUpdate deviceName(String deviceName) {
    ...
    public BlockDeviceMappingVmUpdate noDevice(String noDevice) {
    ...
    public BlockDeviceMappingVmUpdate virtualDeviceName(String virtualDeviceName) {
    ...
    public boolean equals(Object o) {
        ...
        BlockDeviceMappingVmUpdate blockDeviceMappingVmUpdate = (BlockDeviceMappingVmUpdate) o;
        return Objects.equals(this.bsu, blockDeviceMappingVmUpdate.bsu)
                && Objects.equals(this.deviceName, blockDeviceMappingVmUpdate.deviceName)
                && Objects.equals(this.noDevice, blockDeviceMappingVmUpdate.noDevice)
                && Objects.equals(
                        this.virtualDeviceName, blockDeviceMappingVmUpdate.virtualDeviceName);
    }
    ...
    public String toString() {
        ...
        sb.append("class BlockDeviceMappingVmUpdate {\n");
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!BlockDeviceMappingVmUpdate.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in BlockDeviceMappingVmUpdate is not"
                                        + " found in the empty JSON string",
                                BlockDeviceMappingVmUpdate.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `BlockDeviceMappingVmUpdate` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BlockDeviceMappingVmUpdate.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BlockDeviceMappingVmUpdate' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<BlockDeviceMappingVmUpdate>() {
                        @Override
                        public void write(JsonWriter out, BlockDeviceMappingVmUpdate value)
                                throws IOException {
