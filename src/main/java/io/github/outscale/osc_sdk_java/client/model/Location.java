...
public class Location {
    ...
    /**
     * The location code, to be set as the &#x60;Location&#x60; parameter of the *CreateDirectLink*
     * method when creating a DirectLink.
     *
     * @return code
     */
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.code, location.code) && Objects.equals(this.name, location.name);
    }
        ...
        if (jsonObj == null) {
            if (!Location.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in Location is not found in the empty"
                                        + " JSON string",
