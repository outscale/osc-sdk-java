...
public class LinkNicRequest {
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("DeviceNumber");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LinkNicRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinkNicRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinkNicRequest is not found in the empty JSON string", LinkNicRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!LinkNicRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinkNicRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinkNicRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinkNicRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinkNicRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinkNicRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinkNicRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LinkNicRequest>() {
           @Override
           public void write(JsonWriter out, LinkNicRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinkNicRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LinkNicRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LinkNicRequest
  * @throws IOException if the JSON string is invalid with respect to LinkNicRequest
  */
  public static LinkNicRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinkNicRequest.class);
  }

 /**
  * Convert an instance of LinkNicRequest to an JSON string
  *
  * @return JSON string
  */
