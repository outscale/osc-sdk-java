...
public class UpdateAccessKeyRequest {
    ...
    /**
     * The name of the EIM the access key you want to modify is associated with. If you do not
     * specify a user name, this action modifies the access key of the user who sends the request
