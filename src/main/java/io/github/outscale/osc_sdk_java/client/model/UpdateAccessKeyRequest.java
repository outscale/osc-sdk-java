...
public class UpdateAccessKeyRequest {
    ...
    public UpdateAccessKeyRequest expirationDate(String expirationDate) {
     ...
     * format (for example, &#x60;2020-06-14T00:00:00.000Z&#x60; or &#x60;2020-06-14&#x60;). If not
     * specified, the access key is set to not expire.
     *
    ...
    /**
     * The name of the EIM user that the access key you want to modify is associated with. If you do
     * not specify a user name, this action modifies the access key of the user who sends the
    ...
    @Override
    public int hashCode() {
        return Objects.hash(accessKeyId, dryRun, expirationDate, state, userName);
    }
