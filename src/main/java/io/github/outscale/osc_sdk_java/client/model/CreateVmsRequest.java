...
public class CreateVmsRequest {
     ...
     * is limited to 500 kibibytes (KiB). For more information about user data, see [Configuring a
     * VM with User Data and OUTSCALE
     * Tags](https://docs.outscale.com/en/userguide/Configuring-a-VM-with-User-Data-and-OUTSCALE-Tags.html).
     *
     * @return userData
     */
    @javax.annotation.Nullable
