...
public class LinkPublicIpResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to LinkPublicIpResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinkPublicIpResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinkPublicIpResponse is not found in the empty JSON string", LinkPublicIpResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!LinkPublicIpResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinkPublicIpResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinkPublicIpResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinkPublicIpResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinkPublicIpResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinkPublicIpResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LinkPublicIpResponse>() {
           @Override
           public void write(JsonWriter out, LinkPublicIpResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinkPublicIpResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LinkPublicIpResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LinkPublicIpResponse
  * @throws IOException if the JSON string is invalid with respect to LinkPublicIpResponse
  */
  public static LinkPublicIpResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinkPublicIpResponse.class);
  }

 /**
  * Convert an instance of LinkPublicIpResponse to an JSON string
  *
  * @return JSON string
  */
