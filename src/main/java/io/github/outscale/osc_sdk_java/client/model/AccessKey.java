...
public class AccessKey {
    ...
    public AccessKey creationDate(String creationDate) {
    ...
    public AccessKey expirationDate(String expirationDate) {
    ...
    public AccessKey lastModificationDate(String lastModificationDate) {
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!AccessKey.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AccessKey is not found in the empty"
                                        + " JSON string",
        ...
        if ((jsonObj.get("LastModificationDate") != null
                        && !jsonObj.get("LastModificationDate").isJsonNull())
                && !jsonObj.get("LastModificationDate").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `LastModificationDate` to be a primitive type in"
                                    + " the JSON string but got `%s`",
                            jsonObj.get("LastModificationDate").toString()));
        }
