...
public class ReadDirectLinkInterfacesResponse {
    ...
    public ReadDirectLinkInterfacesResponse directLinkInterfaces(
            List<DirectLinkInterfaces> directLinkInterfaces) {

        this.directLinkInterfaces = directLinkInterfaces;
        return this;
    }

    public ReadDirectLinkInterfacesResponse addDirectLinkInterfacesItem(
            DirectLinkInterfaces directLinkInterfacesItem) {
    ...
    public ReadDirectLinkInterfacesResponse nextPageToken(byte[] nextPageToken) {
    ...
    public boolean equals(Object o) {
        ...
        ReadDirectLinkInterfacesResponse readDirectLinkInterfacesResponse =
                (ReadDirectLinkInterfacesResponse) o;
        return Objects.equals(
                        this.directLinkInterfaces,
                        readDirectLinkInterfacesResponse.directLinkInterfaces)
                && Arrays.equals(this.nextPageToken, readDirectLinkInterfacesResponse.nextPageToken)
                && Objects.equals(
                        this.responseContext, readDirectLinkInterfacesResponse.responseContext);
    }

    @Override
    public int hashCode() {
        return Objects.hash(directLinkInterfaces, Arrays.hashCode(nextPageToken), responseContext);
    }
    ...
    public String toString() {
        ...
        sb.append("    directLinkInterfaces: ")
                .append(toIndentedString(directLinkInterfaces))
                .append("\n");
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!ReadDirectLinkInterfacesResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ReadDirectLinkInterfacesResponse is"
                                        + " not found in the empty JSON string",
                                ReadDirectLinkInterfacesResponse.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `ReadDirectLinkInterfacesResponse` properties. JSON: %s",
                                entry.getKey(), jsonObj.toString()));
            }
        }
        if (jsonObj.get("DirectLinkInterfaces") != null
                && !jsonObj.get("DirectLinkInterfaces").isJsonNull()) {
            JsonArray jsonArraydirectLinkInterfaces =
                    jsonObj.getAsJsonArray("DirectLinkInterfaces");
            if (jsonArraydirectLinkInterfaces != null) {
                // ensure the json data is an array
                if (!jsonObj.get("DirectLinkInterfaces").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `DirectLinkInterfaces` to be an array in"
                                            + " the JSON string but got `%s`",
                                    jsonObj.get("DirectLinkInterfaces").toString()));
                }

                // validate the optional field `DirectLinkInterfaces` (array)
                for (int i = 0; i < jsonArraydirectLinkInterfaces.size(); i++) {
                    DirectLinkInterfaces.validateJsonObject(
                            jsonArraydirectLinkInterfaces.get(i).getAsJsonObject());
                }
                ;
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ReadDirectLinkInterfacesResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ReadDirectLinkInterfacesResponse' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ReadDirectLinkInterfacesResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ReadDirectLinkInterfacesResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ReadDirectLinkInterfacesResponse>() {
                        @Override
                        public void write(JsonWriter out, ReadDirectLinkInterfacesResponse value)
                                throws IOException {
                        ...
                        @Override
                        public ReadDirectLinkInterfacesResponse read(JsonReader in)
                                throws IOException {
