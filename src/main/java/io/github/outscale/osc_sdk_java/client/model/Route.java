...
public class Route {
    ...
    public String toString() {
        ...
        sb.append("    destinationIpRange: ")
                ...
                .append("\n");
        sb.append("    destinationServiceId: ")
                .append(toIndentedString(destinationServiceId))
                .append("\n");
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        ...
        if ((jsonObj.get("CreationMethod") != null && !jsonObj.get("CreationMethod").isJsonNull())
                && !jsonObj.get("CreationMethod").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `CreationMethod` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("CreationMethod").toString()));
        }
        ...
        if ((jsonObj.get("DestinationServiceId") != null
                        && !jsonObj.get("DestinationServiceId").isJsonNull())
                && !jsonObj.get("DestinationServiceId").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `DestinationServiceId` to be a primitive type in"
                                    + " the JSON string but got `%s`",
                            jsonObj.get("DestinationServiceId").toString()));
        }
        ...
        if ((jsonObj.get("VmAccountId") != null && !jsonObj.get("VmAccountId").isJsonNull())
                && !jsonObj.get("VmAccountId").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `VmAccountId` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("VmAccountId").toString()));
        }
