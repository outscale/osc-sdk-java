...
public class CreateFlexibleGpuRequest {
     ...
     * possible processor generation is selected (as provided by
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!CreateFlexibleGpuRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CreateFlexibleGpuRequest is not found"
                                        + " in the empty JSON string",
                                CreateFlexibleGpuRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `CreateFlexibleGpuRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateFlexibleGpuRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateFlexibleGpuRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<CreateFlexibleGpuRequest>() {
                        @Override
                        public void write(JsonWriter out, CreateFlexibleGpuRequest value)
                                throws IOException {
