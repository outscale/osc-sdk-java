...
public class ReadTagsResponse {
    ...
    public ReadTagsResponse nextPageToken(byte[] nextPageToken) {
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.equals(this.nextPageToken, readTagsResponse.nextPageToken)
                && Objects.equals(this.responseContext, readTagsResponse.responseContext)
                && Objects.equals(this.tags, readTagsResponse.tags);
    }

    @Override
    public int hashCode() {
        return Objects.hash(Arrays.hashCode(nextPageToken), responseContext, tags);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!ReadTagsResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ReadTagsResponse is not found in the"
                                        + " empty JSON string",
                                ReadTagsResponse.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ReadTagsResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ReadTagsResponse>() {
                        @Override
                        public void write(JsonWriter out, ReadTagsResponse value)
                                throws IOException {
