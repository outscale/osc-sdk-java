...
public class NicLight {
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!NicLight.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in NicLight is not found in the empty"
                                        + " JSON string",
                                NicLight.openapiRequiredFields.toString()));
            }
        }
        ...
        if (jsonObj.get("PrivateIps") != null && !jsonObj.get("PrivateIps").isJsonNull()) {
            ...
            if (jsonArrayprivateIps != null) {
                ...
                for (int i = 0; i < jsonArrayprivateIps.size(); i++) {
                    PrivateIpLightForVm.validateJsonObject(
                            jsonArrayprivateIps.get(i).getAsJsonObject());
                }
                ;
            }
        }
