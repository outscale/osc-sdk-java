...
public class CreateNetPeeringRequest {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateNetPeeringRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateNetPeeringRequest is not found in the empty JSON string", CreateNetPeeringRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateNetPeeringRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateNetPeeringRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (!jsonObj.get("AccepterNetId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `AccepterNetId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("AccepterNetId").toString()));
      }
      if (!jsonObj.get("SourceNetId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `SourceNetId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("SourceNetId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateNetPeeringRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateNetPeeringRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateNetPeeringRequest>() {
           @Override
           public void write(JsonWriter out, CreateNetPeeringRequest value) throws IOException {
