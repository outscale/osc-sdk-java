...
public class CreatePolicyVersionRequest {
    ...
    public CreatePolicyVersionRequest document(String document) {
    ...
    public CreatePolicyVersionRequest policyOrn(String policyOrn) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.document, createPolicyVersionRequest.document)
                && Objects.equals(this.policyOrn, createPolicyVersionRequest.policyOrn)
                && Objects.equals(this.setAsDefault, createPolicyVersionRequest.setAsDefault);
    }

    @Override
    public int hashCode() {
        return Objects.hash(document, policyOrn, setAsDefault);
    }
     ...
     * @throws IOException if the JSON Object is invalid with respect to CreatePolicyVersionRequest
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!CreatePolicyVersionRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CreatePolicyVersionRequest is not"
                                        + " found in the empty JSON string",
                                CreatePolicyVersionRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `CreatePolicyVersionRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreatePolicyVersionRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreatePolicyVersionRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<CreatePolicyVersionRequest>() {
                        @Override
                        public void write(JsonWriter out, CreatePolicyVersionRequest value)
                                throws IOException {
