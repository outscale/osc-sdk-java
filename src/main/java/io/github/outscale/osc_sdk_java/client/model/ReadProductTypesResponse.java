...
import io.github.outscale.osc_sdk_java.client.model.ProductType;
...
public class ReadProductTypesResponse {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReadProductTypesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReadProductTypesResponse is not found in the empty JSON string", ReadProductTypesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReadProductTypesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReadProductTypesResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReadProductTypesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReadProductTypesResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReadProductTypesResponse>() {
           @Override
           public void write(JsonWriter out, ReadProductTypesResponse value) throws IOException {
