...
public class UpdateVmRequest {
    ...
    public UpdateVmRequest blockDeviceMappings(
            List<BlockDeviceMappingVmUpdate> blockDeviceMappings) {

        this.blockDeviceMappings = blockDeviceMappings;
        return this;
    }

    public UpdateVmRequest addBlockDeviceMappingsItem(
            BlockDeviceMappingVmUpdate blockDeviceMappingsItem) {
    ...
    /**
     * The name of a keypair you want to associate with the VM.&lt;br /&gt; When you replace the
     * keypair of a VM with another one, the metadata of the VM is modified to reflect the new
     * public key, but the replacement is still not effective in the operating system of the VM. To
     * complete the replacement and effectively apply the new keypair, you need to perform other
     * actions inside the VM. For more information, see [Modifying the Keypair of an
     * Instance](https://docs.outscale.com/en/userguide/Modifying-the-Keypair-of-an-Instance.html).
     *
     * @return keypairName
     */
    @javax.annotation.Nullable
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.blockDeviceMappings, updateVmRequest.blockDeviceMappings)
                ...
                && Objects.equals(
                        ...
                        updateVmRequest.vmInitiatedShutdownBehavior)
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!UpdateVmRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UpdateVmRequest is not found in the"
                                        + " empty JSON string",
                                UpdateVmRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `UpdateVmRequest` properties. JSON: %s",
        ...
        if (jsonObj.get("BlockDeviceMappings") != null
            ...
            if (jsonArrayblockDeviceMappings != null) {
                ...
                for (int i = 0; i < jsonArrayblockDeviceMappings.size(); i++) {
                    BlockDeviceMappingVmUpdate.validateJsonObject(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateVmRequest>() {
                        @Override
                        public void write(JsonWriter out, UpdateVmRequest value)
                                throws IOException {
