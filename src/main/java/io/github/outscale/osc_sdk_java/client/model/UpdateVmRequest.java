...
public class UpdateVmRequest {
    ...
    /**
     * The name of the keypair.&lt;br /&gt; To complete the replacement, manually replace the old
     * public key with the new public key in the ~/.ssh/authorized_keys file located in the VM.
     * Restart the VM to apply the change.
     *
     * @return keypairName
     */
    @javax.annotation.Nullable
