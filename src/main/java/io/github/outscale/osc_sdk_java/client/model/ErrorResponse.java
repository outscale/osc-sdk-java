...
public class ErrorResponse {
    ...
    public ErrorResponse responseContext(ResponseContext responseContext) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.errors, errorResponse.errors)
                && Objects.equals(this.responseContext, errorResponse.responseContext);
    }

    @Override
    public int hashCode() {
        return Objects.hash(errors, responseContext);
    }
        ...
        if (jsonObj == null) {
            if (!ErrorResponse.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ErrorResponse is not found in the"
                                        + " empty JSON string",
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ErrorResponse` properties. JSON: %s",
        ...
        if (jsonObj.get("Errors") != null && !jsonObj.get("Errors").isJsonNull()) {
            ...
            if (jsonArrayerrors != null) {
                ...
                for (int i = 0; i < jsonArrayerrors.size(); i++) {
                    Errors.validateJsonObject(jsonArrayerrors.get(i).getAsJsonObject());
                }
                ;
            }
        }
