...
public class ApiAccessRule {
    ...
    /**
     * One or more IP ranges used for the API access rule, in CIDR notation (for example,
     * &#x60;192.0.2.0/16&#x60;).
     *
     * @return ipRanges
     */
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!ApiAccessRule.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ApiAccessRule is not found in the"
                                        + " empty JSON string",
                                ApiAccessRule.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ApiAccessRule` properties. JSON: %s",
                                entry.getKey(), jsonObj.toString()));
            }
        }
        if ((jsonObj.get("ApiAccessRuleId") != null && !jsonObj.get("ApiAccessRuleId").isJsonNull())
                && !jsonObj.get("ApiAccessRuleId").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
