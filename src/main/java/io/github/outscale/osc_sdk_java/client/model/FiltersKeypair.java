...
public class FiltersKeypair {
    ...
    public static final String SERIALIZED_NAME_KEYPAIR_TYPES = "KeypairTypes";

    @SerializedName(SERIALIZED_NAME_KEYPAIR_TYPES)
    private List<String> keypairTypes = null;
    ...
    public FiltersKeypair keypairTypes(List<String> keypairTypes) {

        this.keypairTypes = keypairTypes;
        return this;
    }

    public FiltersKeypair addKeypairTypesItem(String keypairTypesItem) {
        if (this.keypairTypes == null) {
            this.keypairTypes = new ArrayList<>();
        }
        this.keypairTypes.add(keypairTypesItem);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.keypairFingerprints, filtersKeypair.keypairFingerprints)
                ...
                && Objects.equals(this.keypairTypes, filtersKeypair.keypairTypes);
    }

    @Override
    public int hashCode() {
        return Objects.hash(keypairFingerprints, keypairNames, keypairTypes);
    }
    ...
    public String toString() {
        ...
        sb.append("    keypairFingerprints: ")
                .append(toIndentedString(keypairFingerprints))
                .append("\n");
    ...
    static {
        ...
        openapiFields.add("KeypairTypes");
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!FiltersKeypair.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FiltersKeypair is not found in the"
                                        + " empty JSON string",
                                FiltersKeypair.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `FiltersKeypair` properties. JSON: %s",
                                entry.getKey(), jsonObj.toString()));
            }
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("KeypairFingerprints") != null
                && !jsonObj.get("KeypairFingerprints").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `KeypairFingerprints` to be an array in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("KeypairFingerprints").toString()));
        }
        // ensure the optional json data is an array if present
        ...
        // ensure the optional json data is an array if present
        if (jsonObj.get("KeypairTypes") != null && !jsonObj.get("KeypairTypes").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `KeypairTypes` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("KeypairTypes").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<FiltersKeypair>() {
                        @Override
