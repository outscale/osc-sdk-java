...
public class ReadVmsStateRequest {
    ...
    public ReadVmsStateRequest nextPageToken(byte[] nextPageToken) {
    ...
    public ReadVmsStateRequest resultsPerPage(Integer resultsPerPage) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.allVms, readVmsStateRequest.allVms)
                ...
                && Arrays.equals(this.nextPageToken, readVmsStateRequest.nextPageToken)
                && Objects.equals(this.resultsPerPage, readVmsStateRequest.resultsPerPage);
    }

    @Override
    public int hashCode() {
        return Objects.hash(
                allVms, dryRun, filters, Arrays.hashCode(nextPageToken), resultsPerPage);
    }
