...
public class DeleteNetPeeringRequest {
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!DeleteNetPeeringRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in DeleteNetPeeringRequest is not found"
                                        + " in the empty JSON string",
                                DeleteNetPeeringRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `DeleteNetPeeringRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteNetPeeringRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteNetPeeringRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<DeleteNetPeeringRequest>() {
                        @Override
                        public void write(JsonWriter out, DeleteNetPeeringRequest value)
                                throws IOException {
