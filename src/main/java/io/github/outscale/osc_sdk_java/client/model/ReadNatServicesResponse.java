...
public class ReadNatServicesResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(natServices, responseContext);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReadNatServicesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReadNatServicesResponse is not found in the empty JSON string", ReadNatServicesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReadNatServicesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReadNatServicesResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if (jsonObj.get("NatServices") != null && !jsonObj.get("NatServices").isJsonNull()) {
        ...
        if (jsonArraynatServices != null) {
          ...
          if (!jsonObj.get("NatServices").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `NatServices` to be an array in the JSON string but got `%s`", jsonObj.get("NatServices").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReadNatServicesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReadNatServicesResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReadNatServicesResponse>() {
           @Override
           public void write(JsonWriter out, ReadNatServicesResponse value) throws IOException {
