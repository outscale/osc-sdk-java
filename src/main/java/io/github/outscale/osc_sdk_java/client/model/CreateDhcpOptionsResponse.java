...
public class CreateDhcpOptionsResponse {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateDhcpOptionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDhcpOptionsResponse is not found in the empty JSON string", CreateDhcpOptionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateDhcpOptionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDhcpOptionsResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDhcpOptionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDhcpOptionsResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateDhcpOptionsResponse>() {
           @Override
           public void write(JsonWriter out, CreateDhcpOptionsResponse value) throws IOException {
