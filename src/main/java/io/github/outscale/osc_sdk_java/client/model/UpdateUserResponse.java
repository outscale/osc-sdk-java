...
public class UpdateUserResponse {
    ...
    public UpdateUserResponse responseContext(ResponseContext responseContext) {
    ...
    public UpdateUserResponse user(User user) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.responseContext, updateUserResponse.responseContext)
                && Objects.equals(this.user, updateUserResponse.user);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!UpdateUserResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UpdateUserResponse is not found in"
                                        + " the empty JSON string",
                                UpdateUserResponse.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `UpdateUserResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateUserResponse>() {
                        @Override
                        public void write(JsonWriter out, UpdateUserResponse value)
                                throws IOException {
