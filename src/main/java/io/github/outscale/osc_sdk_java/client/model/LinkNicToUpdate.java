...
public class LinkNicToUpdate {
    ...
    /**
     * If true, the NIC is deleted when the VM is terminated. If false, the NIC is detached from the
     * VM.
     *
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!LinkNicToUpdate.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in LinkNicToUpdate is not found in the"
                                        + " empty JSON string",
                                LinkNicToUpdate.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `LinkNicToUpdate` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<LinkNicToUpdate>() {
                        @Override
                        public void write(JsonWriter out, LinkNicToUpdate value)
                                throws IOException {
