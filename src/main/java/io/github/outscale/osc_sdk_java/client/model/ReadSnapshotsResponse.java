...
public class ReadSnapshotsResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReadSnapshotsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReadSnapshotsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReadSnapshotsResponse is not found in the empty JSON string", ReadSnapshotsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReadSnapshotsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReadSnapshotsResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("Snapshots") != null && !jsonObj.get("Snapshots").isJsonNull()) {
        ...
        if (jsonArraysnapshots != null) {
          ...
          for (int i = 0; i < jsonArraysnapshots.size(); i++) {
            Snapshot.validateJsonObject(jsonArraysnapshots.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReadSnapshotsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReadSnapshotsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReadSnapshotsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReadSnapshotsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ReadSnapshotsResponse>() {
           @Override
           public void write(JsonWriter out, ReadSnapshotsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReadSnapshotsResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ReadSnapshotsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReadSnapshotsResponse
  * @throws IOException if the JSON string is invalid with respect to ReadSnapshotsResponse
  */
  public static ReadSnapshotsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReadSnapshotsResponse.class);
  }

 /**
  * Convert an instance of ReadSnapshotsResponse to an JSON string
  *
  * @return JSON string
  */
