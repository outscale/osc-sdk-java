...
public class ReadVmsResponse {
    ...
    public ReadVmsResponse nextPageToken(byte[] nextPageToken) {
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.equals(this.nextPageToken, readVmsResponse.nextPageToken)
                && Objects.equals(this.responseContext, readVmsResponse.responseContext)
                && Objects.equals(this.vms, readVmsResponse.vms);
    }

    @Override
    public int hashCode() {
        return Objects.hash(Arrays.hashCode(nextPageToken), responseContext, vms);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!ReadVmsResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ReadVmsResponse is not found in the"
                                        + " empty JSON string",
                                ReadVmsResponse.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ReadVmsResponse` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ReadVmsResponse>() {
                        @Override
                        public void write(JsonWriter out, ReadVmsResponse value)
                                throws IOException {
