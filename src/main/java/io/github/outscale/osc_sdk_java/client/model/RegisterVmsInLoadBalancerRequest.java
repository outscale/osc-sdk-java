...
public class RegisterVmsInLoadBalancerRequest {
    ...
    /**
     * One or more IDs of back-end VMs.&lt;br /&gt; Specifying the same ID several times has no
     * effect as each back-end VM has equal weight.
     *
     * @return backendVmIds
     */
    ...
    public boolean equals(Object o) {
        ...
        RegisterVmsInLoadBalancerRequest registerVmsInLoadBalancerRequest =
                (RegisterVmsInLoadBalancerRequest) o;
        return Objects.equals(this.backendVmIds, registerVmsInLoadBalancerRequest.backendVmIds)
                ...
                && Objects.equals(
                        this.loadBalancerName, registerVmsInLoadBalancerRequest.loadBalancerName);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!RegisterVmsInLoadBalancerRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in RegisterVmsInLoadBalancerRequest is"
                                        + " not found in the empty JSON string",
                                RegisterVmsInLoadBalancerRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                    + " `RegisterVmsInLoadBalancerRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!RegisterVmsInLoadBalancerRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'RegisterVmsInLoadBalancerRequest' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<RegisterVmsInLoadBalancerRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(RegisterVmsInLoadBalancerRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<RegisterVmsInLoadBalancerRequest>() {
                        @Override
                        public void write(JsonWriter out, RegisterVmsInLoadBalancerRequest value)
                                throws IOException {
                        ...
                        @Override
                        public RegisterVmsInLoadBalancerRequest read(JsonReader in)
                                throws IOException {
