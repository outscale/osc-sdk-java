...
public class FiltersApiLog {
    ...
    /**
     * The date after which you want to retrieve logged calls, in ISO 8601 format (for example,
    ...
    /**
     * The date before which you want to retrieve logged calls, in ISO 8601 format (for example,
     * &#x60;2020-06-30&#x60;). By default, this date is set to now, or 48 hours after the
