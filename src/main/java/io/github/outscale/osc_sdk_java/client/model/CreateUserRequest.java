...
public class CreateUserRequest {
     ...
     * begin and end with a slash (/), and contain between 1 and 512 alphanumeric characters and/or
    ...
    /**
     * The name of the EIM user you want to create. This user name must contain between 1 and 64
     * alphanumeric characters and/or pluses (+), equals (&#x3D;), commas (,), periods (.), at signs
    ...
    @Override
    public int hashCode() {
        return Objects.hash(dryRun, path, userName);
    }
