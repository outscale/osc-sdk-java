...
public class FiltersVm {
    ...
    private List<String> creationDates = null;
    ...
    public FiltersVm creationDates(List<String> creationDates) {

        this.creationDates = creationDates;
        return this;
    }

    public FiltersVm addCreationDatesItem(String creationDatesItem) {
