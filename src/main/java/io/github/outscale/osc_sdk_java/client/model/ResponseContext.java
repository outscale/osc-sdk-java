...
public class ResponseContext {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.requestId, responseContext.requestId);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!ResponseContext.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ResponseContext is not found in the"
                                        + " empty JSON string",
                                ResponseContext.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ResponseContext` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ResponseContext>() {
                        @Override
                        public void write(JsonWriter out, ResponseContext value)
                                throws IOException {
