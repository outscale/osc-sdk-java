...
public class ReadImageExportTasksResponse {
    ...
    public ReadImageExportTasksResponse addImageExportTasksItem(
            ImageExportTask imageExportTasksItem) {
    ...
    public ReadImageExportTasksResponse nextPageToken(byte[] nextPageToken) {
    ...
    public boolean equals(Object o) {
        ...
        ReadImageExportTasksResponse readImageExportTasksResponse =
                (ReadImageExportTasksResponse) o;
        return Objects.equals(this.imageExportTasks, readImageExportTasksResponse.imageExportTasks)
                && Arrays.equals(this.nextPageToken, readImageExportTasksResponse.nextPageToken)
                && Objects.equals(
                        this.responseContext, readImageExportTasksResponse.responseContext);
    }

    @Override
    public int hashCode() {
        return Objects.hash(imageExportTasks, Arrays.hashCode(nextPageToken), responseContext);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!ReadImageExportTasksResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ReadImageExportTasksResponse is not"
                                        + " found in the empty JSON string",
                                ReadImageExportTasksResponse.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `ReadImageExportTasksResponse` properties. JSON: %s",
                                entry.getKey(), jsonObj.toString()));
            }
        }
        if (jsonObj.get("ImageExportTasks") != null
                && !jsonObj.get("ImageExportTasks").isJsonNull()) {
            ...
            if (jsonArrayimageExportTasks != null) {
                ...
                if (!jsonObj.get("ImageExportTasks").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `ImageExportTasks` to be an array in the"
                                            + " JSON string but got `%s`",
                                    jsonObj.get("ImageExportTasks").toString()));
                }

                // validate the optional field `ImageExportTasks` (array)
                for (int i = 0; i < jsonArrayimageExportTasks.size(); i++) {
                    ImageExportTask.validateJsonObject(
                            jsonArrayimageExportTasks.get(i).getAsJsonObject());
                }
                ;
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ReadImageExportTasksResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ReadImageExportTasksResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ReadImageExportTasksResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ReadImageExportTasksResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ReadImageExportTasksResponse>() {
                        @Override
                        public void write(JsonWriter out, ReadImageExportTasksResponse value)
                                throws IOException {
