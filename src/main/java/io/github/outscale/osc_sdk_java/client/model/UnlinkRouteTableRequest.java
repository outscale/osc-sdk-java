...
public class UnlinkRouteTableRequest {
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (!UnlinkRouteTableRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON object is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UnlinkRouteTableRequest is not found"
                                        + " in the empty JSON string",
                                UnlinkRouteTableRequest.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `UnlinkRouteTableRequest` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UnlinkRouteTableRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UnlinkRouteTableRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UnlinkRouteTableRequest>() {
                        @Override
                        public void write(JsonWriter out, UnlinkRouteTableRequest value)
                                throws IOException {
