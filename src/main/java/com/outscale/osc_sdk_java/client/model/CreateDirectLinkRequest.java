...
public class CreateDirectLinkRequest {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateDirectLinkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDirectLinkRequest is not found in the empty JSON string", CreateDirectLinkRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateDirectLinkRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDirectLinkRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDirectLinkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDirectLinkRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateDirectLinkRequest>() {
           @Override
           public void write(JsonWriter out, CreateDirectLinkRequest value) throws IOException {
