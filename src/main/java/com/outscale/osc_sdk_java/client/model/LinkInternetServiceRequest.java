...
public class LinkInternetServiceRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dryRun, linkInternetServiceRequest.dryRun) &&
        Objects.equals(this.internetServiceId, linkInternetServiceRequest.internetServiceId) &&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinkInternetServiceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinkInternetServiceRequest is not found in the empty JSON string", LinkInternetServiceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!LinkInternetServiceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinkInternetServiceRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinkInternetServiceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinkInternetServiceRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<LinkInternetServiceRequest>() {
           @Override
           public void write(JsonWriter out, LinkInternetServiceRequest value) throws IOException {
