...
public class LinkInternetServiceRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "The ID of the Internet service you want to attach.")
   ...
   * @return netId
  **/
  @ApiModelProperty(required = true, value = "The ID of the Net to which you want to attach the Internet service.")
