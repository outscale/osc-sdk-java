...
public class FiltersQuota {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FiltersQuota.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FiltersQuota is not found in the empty JSON string", FiltersQuota.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FiltersQuota.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FiltersQuota` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("QuotaNames") != null && !jsonObj.get("QuotaNames").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `QuotaNames` to be an array in the JSON string but got `%s`", jsonObj.get("QuotaNames").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("QuotaTypes") != null && !jsonObj.get("QuotaTypes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `QuotaTypes` to be an array in the JSON string but got `%s`", jsonObj.get("QuotaTypes").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("ShortDescriptions") != null && !jsonObj.get("ShortDescriptions").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `ShortDescriptions` to be an array in the JSON string but got `%s`", jsonObj.get("ShortDescriptions").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FiltersQuota>() {
           @Override
