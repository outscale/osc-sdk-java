...
public class DeleteLoadBalancerPolicyResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeleteLoadBalancerPolicyResponse deleteLoadBalancerPolicyResponse = (DeleteLoadBalancerPolicyResponse) o;
    return Objects.equals(this.loadBalancer, deleteLoadBalancerPolicyResponse.loadBalancer) &&
        Objects.equals(this.responseContext, deleteLoadBalancerPolicyResponse.responseContext);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteLoadBalancerPolicyResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeleteLoadBalancerPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteLoadBalancerPolicyResponse is not found in the empty JSON string", DeleteLoadBalancerPolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeleteLoadBalancerPolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteLoadBalancerPolicyResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteLoadBalancerPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteLoadBalancerPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteLoadBalancerPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteLoadBalancerPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteLoadBalancerPolicyResponse>() {
           @Override
           public void write(JsonWriter out, DeleteLoadBalancerPolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteLoadBalancerPolicyResponse read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to DeleteLoadBalancerPolicyResponse
  */
