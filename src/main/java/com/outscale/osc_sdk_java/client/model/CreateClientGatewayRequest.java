...
public class CreateClientGatewayRequest {
   ...
   * @return bgpAsn
  **/
  @ApiModelProperty(required = true, value = "The Autonomous System Number (ASN) used by the Border Gateway Protocol (BGP) to find the path to your client gateway through the Internet. This number must be between `1` and `4294967295`.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The communication protocol used to establish tunnel with your client gateway (only `ipsec.1` is supported).")
  ...
  **/
   ...
   * @return publicIp
  **/
  @ApiModelProperty(required = true, value = "The public fixed IPv4 address of your client gateway.")
