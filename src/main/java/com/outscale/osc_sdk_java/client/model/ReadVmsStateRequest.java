...
import com.outscale.osc_sdk_java.client.model.FiltersVmsState;
...
public class ReadVmsStateRequest {
  ...
  **/
  ...
  @ApiModelProperty(value = "If true, includes the status of all VMs. By default or if set to false, only includes the status of running VMs.")
