...
public class OsuExportSnapshotExportTask {
  ...
  **/
   ...
   * @return osuBucket
  **/
  @ApiModelProperty(required = true, value = "The name of the OOS bucket the snapshot is exported to.")
  ...
  **/
  ...
  @ApiModelProperty(value = "The prefix for the key of the OOS object corresponding to the snapshot.")
