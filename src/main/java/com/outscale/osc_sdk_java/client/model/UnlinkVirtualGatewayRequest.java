...
public class UnlinkVirtualGatewayRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dryRun, unlinkVirtualGatewayRequest.dryRun) &&
        ...
        Objects.equals(this.virtualGatewayId, unlinkVirtualGatewayRequest.virtualGatewayId);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UnlinkVirtualGatewayRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnlinkVirtualGatewayRequest is not found in the empty JSON string", UnlinkVirtualGatewayRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UnlinkVirtualGatewayRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnlinkVirtualGatewayRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnlinkVirtualGatewayRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnlinkVirtualGatewayRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<UnlinkVirtualGatewayRequest>() {
           @Override
           public void write(JsonWriter out, UnlinkVirtualGatewayRequest value) throws IOException {
