...
public class DeleteListenerRuleRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dryRun, deleteListenerRuleRequest.dryRun) &&
        Objects.equals(this.listenerRuleName, deleteListenerRuleRequest.listenerRuleName);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeleteListenerRuleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteListenerRuleRequest is not found in the empty JSON string", DeleteListenerRuleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeleteListenerRuleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteListenerRuleRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteListenerRuleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteListenerRuleRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeleteListenerRuleRequest>() {
           @Override
           public void write(JsonWriter out, DeleteListenerRuleRequest value) throws IOException {
