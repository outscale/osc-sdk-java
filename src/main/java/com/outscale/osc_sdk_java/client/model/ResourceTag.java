...
public class ResourceTag {
   ...
   * @return key
  **/
  @ApiModelProperty(required = true, value = "The key of the tag, with a minimum of 1 character.")
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "The value of the tag, between 0 and 255 characters.")
