...
public class DeleteRouteRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "The exact IP range for the route.")
  ...
  **/
   ...
   * @return routeTableId
  **/
  @ApiModelProperty(required = true, value = "The ID of the route table from which you want to delete a route.")
