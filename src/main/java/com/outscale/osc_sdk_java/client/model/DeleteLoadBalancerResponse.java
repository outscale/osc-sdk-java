...
public class DeleteLoadBalancerResponse {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeleteLoadBalancerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteLoadBalancerResponse is not found in the empty JSON string", DeleteLoadBalancerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeleteLoadBalancerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteLoadBalancerResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteLoadBalancerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteLoadBalancerResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeleteLoadBalancerResponse>() {
           @Override
           public void write(JsonWriter out, DeleteLoadBalancerResponse value) throws IOException {
