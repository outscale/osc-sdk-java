...
public class DeleteVpnConnectionRouteRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "The network prefix of the route to delete, in CIDR notation (for example, `10.12.0.0/16`).")
  ...
  **/
  @ApiModelProperty(required = true, value = "The ID of the target VPN connection of the static route to delete.")
