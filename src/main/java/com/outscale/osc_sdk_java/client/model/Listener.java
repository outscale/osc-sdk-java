...
public class Listener {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Listener.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Listener.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Listener` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if ((jsonObj.get("LoadBalancerProtocol") != null && !jsonObj.get("LoadBalancerProtocol").isJsonNull()) && !jsonObj.get("LoadBalancerProtocol").isJsonPrimitive()) {
