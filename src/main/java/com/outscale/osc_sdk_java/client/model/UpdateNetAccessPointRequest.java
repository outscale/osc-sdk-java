...
public class UpdateNetAccessPointRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addRouteTableIds, updateNetAccessPointRequest.addRouteTableIds) &&
        ...
        Objects.equals(this.netAccessPointId, updateNetAccessPointRequest.netAccessPointId) &&
        Objects.equals(this.removeRouteTableIds, updateNetAccessPointRequest.removeRouteTableIds);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateNetAccessPointRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNetAccessPointRequest is not found in the empty JSON string", UpdateNetAccessPointRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateNetAccessPointRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNetAccessPointRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("AddRouteTableIds") != null && !jsonObj.get("AddRouteTableIds").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `AddRouteTableIds` to be an array in the JSON string but got `%s`", jsonObj.get("AddRouteTableIds").toString()));
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("RemoveRouteTableIds") != null && !jsonObj.get("RemoveRouteTableIds").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `RemoveRouteTableIds` to be an array in the JSON string but got `%s`", jsonObj.get("RemoveRouteTableIds").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNetAccessPointRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNetAccessPointRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateNetAccessPointRequest>() {
           @Override
           public void write(JsonWriter out, UpdateNetAccessPointRequest value) throws IOException {
