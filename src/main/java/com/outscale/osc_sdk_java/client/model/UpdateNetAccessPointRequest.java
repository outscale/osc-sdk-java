...
public class UpdateNetAccessPointRequest {
  ...
  public UpdateNetAccessPointRequest addAddRouteTableIdsItem(String addRouteTableIdsItem) {
    if (this.addRouteTableIds == null) {
      this.addRouteTableIds = new ArrayList<String>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "One or more IDs of route tables to associate with the specified Net access point.")
  ...
  **/
  ...
  public UpdateNetAccessPointRequest addRemoveRouteTableIdsItem(String removeRouteTableIdsItem) {
    if (this.removeRouteTableIds == null) {
      this.removeRouteTableIds = new ArrayList<String>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "One or more IDs of route tables to disassociate from the specified Net access point.")
