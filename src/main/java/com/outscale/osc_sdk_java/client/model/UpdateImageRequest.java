...
public class UpdateImageRequest {
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("PermissionsToLaunch");
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateImageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateImageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateImageRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      // validate the required field `PermissionsToLaunch`
      PermissionsOnResourceCreation.validateJsonObject(jsonObj.getAsJsonObject("PermissionsToLaunch"));
  }
