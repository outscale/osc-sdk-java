...
public class UnlinkInternetServiceRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "The ID of the Internet service you want to detach.")
   ...
   * @return netId
  **/
  @ApiModelProperty(required = true, value = "The ID of the Net from which you want to detach the Internet service.")
