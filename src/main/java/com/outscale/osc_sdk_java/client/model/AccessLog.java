...
public class AccessLog {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccessLog.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AccessLog.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccessLog` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if ((jsonObj.get("OsuBucketName") != null && !jsonObj.get("OsuBucketName").isJsonNull()) && !jsonObj.get("OsuBucketName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `OsuBucketName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("OsuBucketName").toString()));
      }
      if ((jsonObj.get("OsuBucketPrefix") != null && !jsonObj.get("OsuBucketPrefix").isJsonNull()) && !jsonObj.get("OsuBucketPrefix").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `OsuBucketPrefix` to be a primitive type in the JSON string but got `%s`", jsonObj.get("OsuBucketPrefix").toString()));
      }
  }
