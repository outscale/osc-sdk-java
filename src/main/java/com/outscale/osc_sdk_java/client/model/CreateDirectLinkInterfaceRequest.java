...
import com.outscale.osc_sdk_java.client.model.DirectLinkInterface;
...
public class CreateDirectLinkInterfaceRequest {
  ...
  **/
  ...
  public CreateDirectLinkInterfaceRequest directLinkInterface(DirectLinkInterface directLinkInterface) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateDirectLinkInterfaceRequest createDirectLinkInterfaceRequest = (CreateDirectLinkInterfaceRequest) o;
    return Objects.equals(this.directLinkId, createDirectLinkInterfaceRequest.directLinkId) &&
        Objects.equals(this.directLinkInterface, createDirectLinkInterfaceRequest.directLinkInterface) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateDirectLinkInterfaceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateDirectLinkInterfaceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDirectLinkInterfaceRequest is not found in the empty JSON string", CreateDirectLinkInterfaceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateDirectLinkInterfaceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDirectLinkInterfaceRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDirectLinkInterfaceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDirectLinkInterfaceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDirectLinkInterfaceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDirectLinkInterfaceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDirectLinkInterfaceRequest>() {
           @Override
           public void write(JsonWriter out, CreateDirectLinkInterfaceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDirectLinkInterfaceRequest read(JsonReader in) throws IOException {
  ...
  * @throws IOException if the JSON string is invalid with respect to CreateDirectLinkInterfaceRequest
  */
