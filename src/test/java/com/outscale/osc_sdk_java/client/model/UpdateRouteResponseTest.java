...
/**
 * Model tests for UpdateRouteResponse
 */
public class UpdateRouteResponseTest {
    private final UpdateRouteResponse model = new UpdateRouteResponse();
